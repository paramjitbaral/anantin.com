...
const StoreNavbar = () => {
    ...
    return (
        <div className="flex items-center justify-between px-8 py-2 bg-[#1E1914] relative z-50 shadow-[0_5px_20px_rgba(0,0,0,0.3)] sticky top-0">
            ...
            <div className="relative z-10 flex items-center gap-6">
                ...
                <button onClick={handleLogout} className="ml-2 p-2 text-[#b8b0a1] hover:text-[#D4B26F] transition-colors rounded-full hover:bg-[#2C241B]" title="Exit to Storefront">
                    <LogOutIcon size={18} />
                </button>
            </div>
        </div>
