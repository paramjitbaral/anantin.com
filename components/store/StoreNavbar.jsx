...
const StoreNavbar = () => {
    ...
    return (
        <div className="flex items-center justify-between px-8 py-3 bg-[#1E1914] relative z-50 shadow-[0_5px_20px_rgba(0,0,0,0.3)] sticky top-0">
            ...
            <Link href="/" className="relative z-10 flex items-center">
                <div className="relative text-4xl font-semibold text-[#FDFBF7]">
                    ...
                    <p className="absolute text-[7.5px] font-bold uppercase top-2.5 -right-[46px] px-1.5 py-[1.5px] rounded-full flex items-center gap-2 text-[#2c3e50] bg-[#D4B26F] shadow-[0_2px_4px_rgba(0,0,0,0.5)]">
                        VENDOR
                    </p>
                </div>
            </Link>
            ...
            <div className="relative z-10 flex items-center gap-6">
                ...
                <Link href="/" className="ml-2 p-2 text-[#b8b0a1] hover:text-[#D4B26F] transition-colors rounded-full hover:bg-[#2C241B]" title="Exit to Storefront">
                    <LogOutIcon size={18} />
                </Link>
            </div>
        </div>
