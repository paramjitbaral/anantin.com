...
const AdminNavbar = () => {
    ...
    return (
        <div className="flex items-center justify-between px-4 lg:px-12 py-2 bg-[#1E1914] relative z-50 shadow-[0_5px_20px_rgba(0,0,0,0.3)]">
            ...
            <Link href="/" className="relative z-10 flex items-center">
                <div className="relative text-3xl font-semibold text-[#FDFBF7]">
                    ...
                    <p className="absolute text-[7px] font-bold uppercase top-2 -right-[36px] px-1.5 py-[1px] rounded-full flex items-center gap-2 text-[#2c3e50] bg-[#D4B26F] shadow-[0_2px_4px_rgba(0,0,0,0.5)]">
                        ADMIN
                    </p>
                </div>
            </Link>
            <div className="relative z-10 flex items-center gap-3 sm:gap-6">
                ...
                <Link href="/" className="sm:ml-2 p-2 text-[#b8b0a1] hover:text-[#D4B26F] transition-colors rounded-full hover:bg-[#2C241B]" title="Logout">
                    <LogOutIcon size={18} />
                </Link>
            </div>
        </div>
